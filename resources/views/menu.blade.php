...
<body class="min-h-screen flex flex-col lg:flex-row bg-[#f1e7d1] scroll-smooth">
  ...
  <main class="flex-grow p-4">
    <!-- Slideshow Container -->
    <div class="w-100 h-60 bg-amber-100 rounded-xl shadow-lg relative overflow-hidden">
      <!-- Slides -->
  ...
  <!-- Footer -->
  <footer class="fixed bottom-0 left-0 right-0 lg:left-48 bg-[#4f3222] text-white text-center py-4">
    Koffnes
  </footer>
