<div class="p-2 menu-card bg-[#FFF2E2] shadow-md rounded-lg overflow-hidden sm:w-1/2 md:w-1/3 lg:w-1/4">
          <img
          ...
          />
            ...
            <p class="text-[#412f26] text-sm sm:text-base">Rp. {{number_format($menu->harga, 0, ',', '.')}}</p>
