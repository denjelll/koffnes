<div
    class="font-sans"
    style="background-image: url('{{ asset('storage/asset/gambar/motif.png') }}'); background-size: 400px 400px; background-repeat: repeat; ">
    ...
    <header
        ...
        <img
            ...
            <button
                class="bg-[#301c1c] hover:bg-red-500 text-white font-semibold py-1 px-4 rounded-full transition hover:scale-105 duration-300 ease-in-out  shadow-lg">
        ...
        <div class="flex pt-20 min-h-screen pb-20">
            ...
            <nav
                ...
                <ul class="space-y-4">
                    ...
                    <li>
                        ...
                        <li>
                            <a
                                href="{{ route('koffnesstatus') }}"
                                class="hover:bg-opacity-50 p-2 block rounded">Koffnes Status</a>
                        </li>
                    </ul>
                </nav>
                ...
                <div class="ml-0 md:ml-40 w-full p-4 md:p-7">
                    ...
                    <!-- Content Area with Flex Layout -->
                    <div class="w-full p-2 pb-[2rem]">
                        <!-- Tambahkan padding-bottom -->
                        <div class="flex items-center justify-center h-auto p-4">
                            <!-- Card dengan ukuran lebih besar -->
                            <div
                                class="w-full max-w-[600px] sm:w-full bg-[#e8d2b7] rounded-lg shadow-md p-6 overflow-x-auto">
                                <table class="w-full text-left border-collapse">
                                    <thead>
                                        <tr>
                                            <th class="py-3 px-4 border-b font-bold text-gray-800 text-sm sm:text-base">Nama Produk</th>
                                            <th class="py-3 px-4 border-b font-bold text-gray-800 text-sm sm:text-base">Quantity</th>
                                            <th class="py-3 px-4 border-b font-bold text-gray-800 text-sm sm:text-base">Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($menus as $menu)
                                        <tr>
                                            <td class="py-3 px-4 border-b text-gray-700 text-xs sm:text-sm">{{ $menu->nama_menu }}</td>
                                            <td class="py-3 px-4 border-b text-gray-700 text-xs sm:text-sm">
                                            ...
                                            <td class="py-3 px-4 border-b">
                                                <button
                                                    wire:click="openAddStockPopup({{ $menu->id_menu }})"
                                                    class="bg-[#412f26] text-white px-3 py-2 rounded text-xs sm:text-sm">
                                                    Add
                                                </button>
                                            </td>
                                        </tr>
            ...
            <footer
                ...
                @if ($isAddingStock)
                <div
                    class="fixed inset-0 flex items-center justify-center bg-[#000000] bg-opacity-50 z-50">
                    <div class="bg-[#e8d2b7] p-6 rounded shadow-md w-80">
                        <h2 class="text-xl font-bold text-[#412f26] mb-4">Tambah Stok</h2>
                        <p class="mb-2 text-[#412f26]">Nama Menu:
                            <strong>{{ $menuName }}</strong>
                        </p>
                        <p class="mb-4 text-[#412f26]">Stok Saat Ini:
                            <strong>{{ $menuStock }}</strong>
                        </p>
