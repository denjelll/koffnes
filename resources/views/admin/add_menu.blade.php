...
<div class="px-8 py-6 pb-[4rem]">
    ...
    <form action="{{ route('admin.store') }}" method="post" enctype="multipart/form-data" class="bg-[#f1e8d4] shadow-md rounded-lg p-6">
        @csrf
        <div class="mb-4">
        ...
        <div id="promo-container" style="display: none;">
            ...
            <div class="mb-4">
                ...
                <div class="flex flex-wrap gap-4">
                    @foreach(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'AllDay'] as $day)
                        <label class="inline-flex items-center">
                            <input type="radio" name="hari" value="{{ $day }}" class="form-radio text-[#412f26]">
                            <span class="ml-2">{{ $day == 'AllDay' ? 'Setiap hari' : $day }}</span>
                        </label>
                    @endforeach
                </div>
            </div>
