...
<div class="font-sans" style="background-color: #fff2e2;">
    ...
    <div class="flex h-screen pb-20">
        ...
        <nav
            ...
            <ul class="space-y-4">
                <li>
                    <a href="#" class="hover:bg-opacity-50 p-2 block rounded">Home</a>
                </li>
                <li>
                    <a href="#" class="hover:bg-opacity-50 p-2 block rounded">Order</a>
                </li>
                <li>
                    <a href="#" class="hover:bg-opacity-50 p-2 block rounded">History<br>Transaksi</a>
                </li>
                <li>
                    <a href="#" class="hover:bg-opacity-50 p-2 block rounded">Inventory</a>
                </li>
                <li>
